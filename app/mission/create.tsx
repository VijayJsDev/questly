// app/mission/create.tsx — Create Mission Modal (Placeholder)
    ...
    <View style={{ flex: 1, backgroundColor: colors.surfaceElevated }}>
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', padding: spacing[6] }}>
        ...
        <Text style={{ ...typography.textVariants.title, color: colors.textPrimary, marginBottom: spacing[2] }}>
          Mission form coming soon
        </Text>
        <Text style={{ ...typography.textVariants.body, color: colors.textSecondary, textAlign: 'center' }}>
          This will use React Hook Form + Zod for validation, with fields for title, description, priority, and daily reset.
        </Text>
      </View>
    </View>
  );
